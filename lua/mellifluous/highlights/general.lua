...
function M.set(hl, colors)
    ...
    --hl.set('ModeMsg', { fg = colors.fg3 })                                   default settings, saving just incase
    hl.set('ModeMsg', { link = 'Normal' })                                   -- 'showmode' message (e.g., '-- INSERT -- ')
    ...
    hl.set('Search', { bg = colors.bg, fg = colors.fg_search })                                         -- Last search pattern highlighting (see 'hlsearch'). Also used for similar items that need to stand out.
